...
<html>
    <head>
        ...
        body{background: url(img/login_bkg.jpg) no-repeat;background-size:cover;font-size: 16px;}  
    ...
    <body>
        <html:form action="/login">
        	<div class="mycenter">
        		<div class="mysign">
            		<input class="form-control required" type="text" placeholder="账号" name="username" autofocus="autofocus" maxlength="30"/><html:errors property="username"/><br/>
